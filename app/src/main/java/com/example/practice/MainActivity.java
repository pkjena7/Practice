...
import com.example.practice.adapter.StudentListAdapter;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerview = findViewById(R.id.listview_student);
        ...
        mStudentList = mDBHelper.getListProduct();
        //Init adapter
        adapter = new StudentListAdapter(this, mStudentList);
...
//        );
    ...
    protected void onResume() {
        ...
        mStudentList = mDBHelper.getListProduct();
        //Init adapter
        adapter.updateList(mStudentList);
    }
